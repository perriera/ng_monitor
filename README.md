...
**Recommended**: The project now has been successfully created in git already. So add your first github tag:
    ...
    git tag -a v0.1.0 -m "Created ng_monitor"
...
For example, instead of:
    ...
    [Unreleased]: https://github.com/perriera/ng_monitor/compare/v0.7.0...HEAD
    [0.7.0]: https://github.com/perriera/ng_monitor/compare/v0.6.6...v0.7.0
...
Make it more like:
    ...
    [Unreleased]: https://github.com/perriera/ng_monitor/compare/v0.2.0...HEAD
    [0.2.0]: https://github.com/perriera/ng_monitor/compare/v0.1.0...v0.2.0
    [0.1.0]: https://github.com/perriera/ng_monitor/releases/tag/v0.1.0
...
This will re-create the project now with all references to ng_monitor changed to ng_monitor. To test this do the following:

    build/run-unittests-<press tab>

**Recommended**: The project now has been successfully created in git already. So add your first github tag:

    git tag -a v0.2.0 -m "Renamed C++ template to: ng_monitor"
    git push origin v0.2.0

## Changelog.md & include/version.hpp

Remember, when you go to make changes to your changelog.md you should maintain the version number of your project using 'include/version.hpp'. For example, in your version.hpp will look something similiar to the following but all referenced to NG_MONITOR will be changed to ng_monitor
